function StartGame() {
    ...
    var instruct = document.getElementById("instr");
...
instructions.setAttribute("src", "./images/instruct.png");
instructions.setAttribute("class", "instructions");
instructions.setAttribute("id", "instructions");
instructions.addEventListener("click", Instructions);
instructions.removeEventListener("click", selectTool);

var elems = [elem0, elem1, elem2, inventory, instructions];
...
function selectTool(event) {
    ...
    for (var i = 0; i < toolList.length - 1; i++) {
